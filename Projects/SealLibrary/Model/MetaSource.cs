...
namespace Seal.Model
{
    public class MetaSource : ReportComponent
    {
        ...
        public MetaTable AddTable(bool forReport)
        {
            ...
            metaTable.Name = "NewTable";

            metaTable.DynamicColumns = forReport;
            metaTable.Source = this;
            metaTable.Name = Helper.GetUniqueName(metaTable.Name, (from i in MetaData.Tables select i.Name).ToList());
            MetaData.Tables.Add(metaTable);
            return metaTable;
        }
