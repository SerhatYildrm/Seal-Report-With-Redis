    ...
    public class MetaConnection : RootComponent
    {
        ...
        public string SQLServerConnectionString
        {
            get
            {
                ...
                //if(this.DatabaseType == DatabaseType.Redis) { result = "this is redis."; }
        ...
        public void CheckConnection()
        {
            ...
            catch (Exception ex)
            {
                ...
                if (this.DatabaseType == DatabaseType.Redis)
                {
                    try
                    {
                        Redis testRedisConnect = new Redis();
                        testRedisConnect.Connect(ConnectionString);
                        testRedisConnect.Close();
                        
                        _information = "Redis Server Bağlantısı sağlandı.";
                    }
                    catch (Exception e)
                    {
                        _information = e.ToString();
                    } 
                }
